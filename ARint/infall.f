...
*
   ...
   98     FORMAT (' INFALL CHECK:   T CG ',F10.5,1P,6E9.1)
      ...
      END IF
*
*       Include optional velocity kick (only 1st component for simplicity).
      IF (KZ(43).EQ.0) GO TO 120
...
*       Correct for energy gain & ECH and re-initialize chain c.m.
      ...
      WRITE (6,100)  LIST(1,ICH), IESC, ISUB, STEP(ICH), STEPR(ICH)
  100 FORMAT (' SINGLE BH    NNB IESC ISUB SI SR ',
     &                       I5,2I4,1P,2E10.2)
